    ...
    translations: {
      ...
      queueIntegration: {
        ...
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage:
            "Você tem certeza? Essa ação não pode ser revertida! e será removida das setors e conexões vinculadas",
        },
      },
      files: {
      ...
      queues: {
        ...
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage:
            "Você tem certeza? Essa ação não pode ser revertida! Os atendimentos dessa setor continuarão existindo, mas não terão mais nenhum setor atribuída.",
        },
      },
      queueSelect: {
        inputLabel: "Setors",
